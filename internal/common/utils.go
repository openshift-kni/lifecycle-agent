...
func GetConfigMap(ctx context.Context, c client.Client, configMap v1.ConfigMapRef) (*corev1.ConfigMap, error) {
...
func GetConfigMaps(ctx context.Context, c client.Client, configMaps []v1.ConfigMapRef) ([]corev1.ConfigMap, error) {
	var cms []corev1.ConfigMap
	var cmSet = map[v1.ConfigMapRef]bool{}
	var uniqueCms []v1.ConfigMapRef
...
func GetDesiredStaterootName(ibu *v1.ImageBasedUpgrade) string {
	return GetStaterootName(ibu.Spec.SeedImageRef.Version)
}

func GetStaterootCertsDir(ibu *v1.ImageBasedUpgrade) string {

...
func LaunchStaterootSetupJob(ctx context.Context, c client.Client, ibu *v1alpha1.ImageBasedUpgrade, scheme *runtime.Scheme, log logr.Logger) (*batchv1.Job, error) {
...
func constructJobForStaterootSetup(ctx context.Context, c client.Client, ibu *v1alpha1.ImageBasedUpgrade, scheme *runtime.Scheme, log logr.Logger) (*batchv1.Job, error) {

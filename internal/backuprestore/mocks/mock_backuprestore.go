...
func (mr *MockBackuperRestorerMockRecorder) CleanupBackups(ctx any) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCall(mr.mock, "CleanupBackups", ctx)
}
...
func (mr *MockBackuperRestorerMockRecorder) PatchPVsReclaimPolicy(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCall(mr.mock, "PatchPVsReclaimPolicy", ctx)
}
...
func (mr *MockBackuperRestorerMockRecorder) RestorePVsReclaimPolicy(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCall(mr.mock, "RestorePVsReclaimPolicy", ctx)
}
...
func (mr *MockBackuperRestorerMockRecorder) StartBackup(ctx, content, targetDir any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCall(mr.mock, "StartBackup", ctx, content, targetDir)
}
...
func (mr *MockBackuperRestorerMockRecorder) StartRestore(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCall(mr.mock, "StartRestore", ctx)
}
...
func (mr *MockBackuperRestorerMockRecorder) ValidateBackupConfigmaps(ctx, content any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCall(mr.mock, "ValidateBackupConfigmaps", ctx, content)
}

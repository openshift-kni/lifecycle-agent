...
func TestImageBasedUpgradeReconciler_cleanupUnbootedStateroot(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := cleanupUnbootedStateroot(context.TODO(), tt.input, r.Ops, r.OstreeClient, r.RPMOstreeClient); (err != nil) != tt.wantErr {
...
func TestCheckManualCleanup(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotIbu := &ibuv1.ImageBasedUpgrade{}
...
func TestImageBasedUpgradeReconciler_cleanupUnbootedStateroots(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err := CleanupUnbootedStateroots(context.TODO(), r.Log, r.Ops, r.OstreeClient, r.RPMOstreeClient); (err != nil) != tt.wantErr {

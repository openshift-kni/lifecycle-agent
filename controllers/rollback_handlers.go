...
//nolint:unparam
func (r *ImageBasedUpgradeReconciler) startRollback(ctx context.Context, ibu *lcav1.ImageBasedUpgrade) (ctrl.Result, error) {
...
func (r *ImageBasedUpgradeReconciler) finishRollback(ibu *lcav1.ImageBasedUpgrade) (ctrl.Result, error) {
...
//nolint:unparam
func (r *ImageBasedUpgradeReconciler) handleRollback(ctx context.Context, ibu *lcav1.ImageBasedUpgrade) (ctrl.Result, error) {

...
type ImageBasedUpgradeStatus struct {
	...
	// RollbackAvailabililtyExpiration reflects the point at which rolling back may require manual recovery from expired control plane certficates.
	//+operator-sdk:csv:customresourcedefinitions:type=spec,xDescriptors={"urn:alm:descriptor:com.tectonic.ui:text"}
	RollbackAvailabililtyExpiration string `json:"rollbackAvailabililtyExpiration,omitempty"`
}

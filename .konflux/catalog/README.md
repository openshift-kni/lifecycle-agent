...
- `4.22/` — same 5.0 FBC component (`lifecycle-agent-fbc-5-0`), built from this directory so 4.22 z-streams can be released into the 5.0 catalog without the 5.0 placeholder. Released 4.22.0 and 4.22.1 are static (no placeholder). Static 5.0 bundles will be added here over time.
